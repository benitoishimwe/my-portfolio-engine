    ...
    return (
        <section className="min-h-[90vh] flex flex-col justify-center container mx-auto px-4 relative">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    <p className="text-primary font-mono tracking-wider">Hi, my name is</p>
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed mt-6">
                        I am a versatile engineer with a unique blend of cloud engineering, backend development, and cross‑functional project leadership. I translate complex business requirements into reliable, production-grade technical systems.
                    </p>
                    ...
                    <div className="flex flex-wrap items-center gap-4 pt-8">
                        ...
                        <a href="#projects">
                            <Button size="lg" variant="outline" className="h-12 border-primary/50 text-foreground hover:bg-primary/10">
                                View Projects
                            </Button>
                        </a>
                    </div>
                    ...
                    <div className="flex items-center gap-6 pt-12">
                        <a href="https://github.com/benitoishimwe" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-all hover:-translate-y-1">
                            <Github className="w-6 h-6" />
                            <span className="sr-only">GitHub</span>
                        </a>
                        <a href="https://www.linkedin.com/in/benito-ishimwe/" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-all hover:-translate-y-1">
                            <Linkedin className="w-6 h-6" />
                            <span className="sr-only">LinkedIn</span>
                        </a>
                        <a href="mailto:benishimwe31@gmail.com" className="text-muted-foreground hover:text-primary transition-all hover:-translate-y-1">
