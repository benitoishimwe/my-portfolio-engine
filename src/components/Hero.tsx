      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] xl:text-[6rem] font-bold tracking-tighter text-foreground leading-tight md:leading-[1.1]">
            ...
            <span className="text-primary text-4xl md:text-5xl lg:text-6xl xl:text-7xl">{siteConfig.title}.</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-8">
            ...
            <a href={siteConfig.resumeUrl} target="_blank" rel="noreferrer">
              <Button size="lg" variant="outline" className="h-12 border-primary/50 text-foreground hover:bg-primary/10 gap-2">
